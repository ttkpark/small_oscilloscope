...
- 노브에 1k 저항 직렬 연결 및 캐패시터 병렬 연결
- GPIO4 -> GPIO35 : ADC2는 와이파이 사용  중엔 사용불가.
- 3.3V 전원 이상함.
- 릴레이 핀맵 다름.
- CH340C 전원을 USB 말고 5V로 변경.
- 릴레이에 5V 전원 사이에 10옴 저항 연결
- R82 그래픽드라이버 칩단에 캐패시터 연결
- SPI 그래픽칩과 본체 사이 저항 10옴 삭제
- 
